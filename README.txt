...
The first is a stand-alone caesar_encode.c, the rest belongs to caesar_decode.c.
...
-To compile caesar_decode.c:
    make all
-To clean all object files:
    make clean
-Examples of command line arguments:
./caesar_decode -stx -F encoded_sample1.txt -O decoded.txt
./caesar_decoded -F encoded_sample1.txt
./caesar_decoded -S -F encoded_sample2.txt -O new_file.txt
and so on...
